...
BOOL InitConfiguration(void)
{
    ...
    ConfigSetDefaultInt(l_ConfigVideoRice, "ForceTextureFilter", 1, "Force to use texture filtering or not (0=auto: n64 choose, 1=force no filtering, 2=force filtering)");
